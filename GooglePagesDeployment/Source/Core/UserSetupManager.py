...
if not exist "StartAndyGoogle.py" (
...
$StartupScript = Join-Path $InstallPath "StartAndyGoogle.py"
...
installPath = "{self.AndyLibraryDir}"
startupScript = installPath & "\\StartAndyGoogle.py"

' Change to installation directory
objShell.CurrentDirectory = installPath

' Launch AndyLibrary silently (no console window)
objShell.Run "python StartAndyGoogle.py", 0, False
